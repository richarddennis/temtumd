...
const addressRoutes = {
    init: (app, addressEntity) => {
         ...
         *     }
         */
        app.post(helpers_1.default.createV1Route('/address/create'), (req, res) => {
            res.send(addressEntity.addressCreate());
        });
        app.get(helpers_1.default.createV1Route('/address/:address/unspent'), (req, res) => {
         ...
         *     }
         */
        app.get(helpers_1.default.createV1Route('/address/:address/balance'), (req, res) => {
            const { address } = req.params;
